...
class TTexts {
  ...
  static const String appName = "altinbas store";
  ...
  static const String signupScreenSubTitle =
      "A one-time SMS will be sent for verification";
  ...
  static const String pinCodeSuccessMessage =
      "Your Pin Code has been saved successfully.";
